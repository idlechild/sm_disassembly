...
IntroCeresExplosionSpritemaps_IntroTextNextPageArrowFrame1:
    dw $0002                                                             ;8C8CCF;
    %spritemapEntry(0, $1FF, $00, 0, 1, 3, 6, $1A8)
    %spritemapEntry(0, $1F8, $00, 0, 0, 3, 6, $1A8)

IntroCeresExplosionSpritemaps_IntroTextNextPageArrowFrame2:
    dw $0002                                                             ;8C8CDB;
    %spritemapEntry(0, $1FF, $00, 0, 1, 3, 6, $19F)
    %spritemapEntry(0, $1F8, $00, 0, 0, 3, 6, $19F)

IntroCeresExplosionSpritemaps_IntroTextNextPageArrowFrame3:
    dw $0002                                                             ;8C8CE7;
...
UNUSED_SpaceSpritemaps_FrenchText_SPACECOLONY_8C9258:
    dw $0010                                                             ;8C9258;
...
SpaceSpritemaps_FrenchText_PlanetZebes:
    dw $0018                                                             ;8C968D;
    %spritemapEntry(0, $2B, $00, 0, 0, 0, 0, $BE)
    %spritemapEntry(0, $2B, $F8, 0, 0, 0, 0, $BD)
    %spritemapEntry(0, $1B, $00, 0, 0, 0, 0, $BC)
    %spritemapEntry(0, $1B, $F8, 0, 0, 0, 0, $BB)
    %spritemapEntry(0, $23, $F8, 0, 0, 0, 0, $B6)
    %spritemapEntry(0, $13, $F8, 0, 0, 0, 0, $B6)
    %spritemapEntry(0, $23, $00, 0, 0, 0, 0, $B5)
    %spritemapEntry(0, $13, $00, 0, 0, 0, 0, $B5)
    %spritemapEntry(0, $0B, $00, 0, 0, 0, 0, $BA)
    %spritemapEntry(0, $0B, $F8, 0, 0, 0, 0, $B9)
    %spritemapEntry(0, $1FD, $F8, 0, 0, 0, 0, $B6)
    %spritemapEntry(0, $1FD, $00, 0, 0, 0, 0, $B5)
    %spritemapEntry(0, $1F5, $00, 0, 0, 0, 0, $B8)
    %spritemapEntry(0, $1F5, $F8, 0, 0, 0, 0, $B7)
    %spritemapEntry(0, $1ED, $00, 0, 0, 0, 0, $B5)
    %spritemapEntry(0, $1ED, $F8, 0, 0, 0, 0, $B6)
    %spritemapEntry(0, $1E5, $00, 0, 0, 0, 0, $B3)
    %spritemapEntry(0, $1E5, $F8, 0, 0, 0, 0, $B2)
    %spritemapEntry(0, $1DD, $00, 0, 0, 0, 0, $B1)
    %spritemapEntry(0, $1DD, $F8, 0, 0, 0, 0, $B0)
    %spritemapEntry(0, $1D5, $F8, 0, 0, 0, 0, $AE)
    %spritemapEntry(0, $1D5, $00, 0, 0, 0, 0, $AF)
    %spritemapEntry(0, $1CD, $F8, 0, 0, 0, 0, $AC)
    %spritemapEntry(0, $1CD, $00, 0, 0, 0, 0, $AD)
...
CinematicBGObjectInstLists_IntroTextPage1:
    dw Instruction_HandleCreatingText_Page1                              ;8CC383;
    dw $0001                                                             ;8CC385;
    db $01,$01                                                           ;8CC387;
...
CinematicBGObjectInstLists_IntroTextPage2:
    dw Instruction_HandleCreatingText_Page2                              ;8CC797;
    dw $0001                                                             ;8CC799;
    db $01,$01                                                           ;8CC79B;
...
CinematicBGObjectInstLists_IntroTextPage3:
    dw Instruction_HandleCreatingText_Page3                              ;8CCB45;
    dw $0001                                                             ;8CCB47;
    db $01,$01                                                           ;8CCB49;
...
CinematicBGObjectInstLists_IntroTextPage4:
    dw Instruction_HandleCreatingText_Page4                              ;8CCE33;
    dw $0001                                                             ;8CCE35;
    db $01,$01                                                           ;8CCE37;
...
CinematicBGObjectInstLists_IntroTextPage5:
    dw Instruction_HandleCreatingText_Page5                              ;8CD15D;
    dw $0001                                                             ;8CD15F;
    db $01,$01                                                           ;8CD161;
...
CinematicBGObjectInstLists_IntroTextPage6:
    dw Instruction_HandleCreatingText_Page6                              ;8CD511;
    dw $0001                                                             ;8CD513;
    db $01,$01                                                           ;8CD515;
...
CinematicBGObjectInstLists_SpaceColony:
    ...
    dw Instruction_SkipNextInstructionIfGermanText                       ;8CD66B;
    dw $0001
    db $08,$1A
    dw IndirectInstructions_IntroText_FrenchText_SpaceColony
    dw $0080
    db $01,$01
    ...
    dw $0001                                                             ;8CD66D;
    db $08,$1A                                                           ;8CD66F;
    dw IndirectInstructions_IntroText_GermanText_SpaceColony             ;8CD671;
    dw $0080                                                             ;8CD673;
    db $01,$01                                                           ;8CD675;
...
IndirectInstructions_IntroText_GermanText_SpaceColony:
    dw IndirectInstructionFunction_DrawTextToTilemap                     ;8CD7F7;
    db $11,$02                                                           ;8CD7F9;
    dw $20C4,$20CA,$20C3,$20C7,$20CC,$20C2,$20C1,$20CB
    dw $20C0,$20C7,$20C7,$20C8,$20C5,$20C8,$20C9,$20CA
    dw $20CB
    dw $20D4,$20DA,$20D3,$20D7,$20DC,$20D2,$20D1,$20DB
    dw $20D0,$20D7,$20D7,$20D8,$20D5,$20D8,$20D9,$20DA
    dw $20DB

IndirectInstructions_IntroText_FrenchText_SpaceColony:
    dw IndirectInstructionFunction_DrawTextToTilemap
    db $10,$02
    dw $20CC,$20CA,$20CD,$20CA,$20CB,$20C9,$20CE,$202F
    dw $20C7,$20CF,$20C5,$20C8,$20C9,$20C5,$20CD,$20CE
    dw $20DC,$20DA,$20DD,$20DA,$20DB,$20D9,$20DE,$202F
    dw $20D7,$20DF,$20D5,$20D8,$20D9,$20D5,$20DD,$20DE

InitialIntroGermanTextTilemap:
    dw $002F,$002F,$002F,$002F,$002F,$1073,$1074,$1091
    dw $002F,$107B,$1074,$1093,$1099,$1093,$1074,$002F
    dw $107C,$1074,$1093,$1091,$107E,$1078,$1073,$002F
    dw $1078,$1092,$1093,$002F,$002F,$002F,$002F,$002F
    dw $002F,$002F,$002F,$002F,$002F,$1083,$1084,$10A1
    dw $002F,$108B,$1084,$10A3,$10A9,$10A3,$1084,$002F
    dw $108C,$1084,$10A3,$10A1,$108E,$1088,$1083,$002F
    dw $1088,$10A2,$10A3,$002F,$002F,$002F,$002F,$002F
    dw $002F,$002F,$002F,$002F,$002F,$002F,$002F,$1078
    dw $107D,$002F,$1076,$1074,$1075,$1070,$107D,$1076
    dw $1074,$107D,$1092,$1072,$1077,$1070,$1075,$1093
    dw $002F,$002F,$002F,$002F,$002F,$002F,$002F,$002F
    dw $002F,$002F,$002F,$002F,$002F,$002F,$002F,$1088
...
InitialIntroGermanAdditionalTextTilemap:
    dw $002F,$002F,$002F,$002F,$002F,$002F,$1074,$1092
    dw $002F,$1077,$1074,$1091,$1091,$1092,$1072,$1077
    dw $1093,$002F,$1096,$1078,$1074,$1073,$1074,$1091
    dw $002F,$002F,$002F,$002F,$002F,$002F,$002F,$002F
    dw $002F,$002F,$002F,$002F,$002F,$002F,$1084,$10A2
    dw $002F,$1087,$1084,$10A1,$10A1,$10A2,$1082,$1087
    dw $10A3,$002F,$10A6,$1088,$1084,$1083,$1084,$10A1
    dw $002F,$002F,$002F,$002F,$002F,$002F,$002F,$002F
    dw $002F,$002F,$002F,$002F,$002F,$1075,$1091,$1078
    dw $1074,$1073,$1074,$107D,$002F,$1078,$107C,$002F
    dw $1094,$107D,$1078,$1095,$1074,$1091,$1092,$1094
    dw $107C,$002F,$002F,$002F,$002F,$002F,$002F,$002F
    dw $002F,$002F,$002F,$002F,$002F,$1085,$10A1,$1088
    dw $1084,$1083,$1084,$108D,$002F,$1088,$108C,$002F
    dw $10A4,$108D,$1088,$10A5,$1084,$10A1,$10A2,$10A4
    dw $108C,$106B,$106B,$106B,$002F,$002F,$002F,$002F

InitialIntroFrenchTextTilemap:
    dw $002F,$002F,$002F,$002F,$002F,$107B,$1074,$002F                   ;8CD81B;
    dw $1073,$1074,$1091,$107D,$1078,$1074,$1091,$002F                   ;8CD82B;
    dw $107C,$1074,$1093,$1091,$107E,$1078,$1073,$1074                   ;8CD83B;
    dw $002F,$1074,$1092,$1093,$002F,$002F,$002F,$002F                   ;8CD84B;
    dw $002F,$002F,$002F,$002F,$002F,$108B,$1084,$002F                   ;8CD85B;
    dw $1083,$1084,$10A1,$108D,$1088,$1084,$10A1,$002F                   ;8CD86B;
    dw $108C,$1084,$10A3,$10A1,$108E,$1088,$1083,$1084                   ;8CD87B;
    dw $002F,$1084,$10A2,$10A3,$002F,$002F,$002F,$002F                   ;8CD88B;
    dw $002F,$002F,$002F,$002F,$002F,$1072,$1070,$107F                   ;8CD89B;
    dw $1093,$1078,$1075,$002F,$002F,$107B,$1070,$002F                   ;8CD8AB;
    dw $107F,$1070,$1078,$1097,$002F,$1091,$1074,$1076                   ;8CD8BB;
    dw $107D,$1074,$002F,$002F,$002F,$002F,$002F,$002F                   ;8CD8CB;
    dw $002F,$002F,$002F,$002F,$002F,$1082,$1080,$108F                   ;8CD8DB;
    dw $10A3,$1088,$1085,$106B,$002F,$108B,$1080,$002F                   ;8CD8EB;
    dw $108F,$1080,$1088,$10A7,$002F,$10A1,$1084,$1086                   ;8CD8FB;
    dw $108D,$1084,$106B,$002F,$002F,$002F,$002F,$002F                   ;8CD90B;
...
Tilemap_PostCredits_1994Nintendo:
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F                   ;8CDEDB;
    dw $004F,$0061,$0069,$0069,$0064,$004F,$004F,$002D                   ;8CDEEB;
    dw $0028,$002D,$0043,$0024,$002D,$0023,$002E,$004F                   ;8CDEFB;
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F                   ;8CDF0B;
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F                   ;8CDF1B;
    dw $004F,$0071,$0079,$0079,$0074,$004F,$004F,$003D                   ;8CDF2B;
    dw $0038,$003D,$0053,$0034,$003D,$0033,$003E,$004F                   ;8CDF3B;
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F                   ;8CDF4B;

Tilemap_PostCredits_ItemPercentageGermanText:
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F
    dw $004F,$0088,$0089,$008A,$008B,$0088,$008C,$008D
    dw $008E,$008E,$0088,$008F,$00A0,$0088,$004F,$004F
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F
    dw $004F,$0098,$0099,$009A,$009B,$0098,$009C,$009D
    dw $009E,$009E,$0098,$009F,$00B0,$0098,$004F,$004F
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F
    dw $004F,$004F,$008B,$0088,$008B,$0088,$008A,$008C
    dw $00A0,$00A1,$008A,$00A2,$0088,$004F,$004F,$004F
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F
    dw $004F,$004F,$009B,$0098,$009B,$0098,$009A,$009C
    dw $00B0,$00B1,$009A,$00B2,$0098,$004F,$004F,$004F
    dw $004F,$004F,$004F,$004F,$004F,$004F,$004F,$004F

Tilemap_PostCredits_ItemPercentageFrenchText:
    dw $004F,$004F,$004F,$004F,$004F,$00A0,$008D,$00A3                   ;8CDF5B;
    dw $00A4,$004F,$00A2,$007F,$00A5,$00A6,$00A7,$0088                   ;8CDF6B;
    dw $00A0,$008C,$004F,$008D,$008E,$008D,$008C,$008C                   ;8CDF7B;
    dw $0088,$008C,$004F,$004F,$004F,$004F,$004F,$004F                   ;8CDF8B;
    dw $004F,$004F,$004F,$004F,$004F,$00B0,$009D,$00B3                   ;8CDF9B;
    dw $00B4,$004F,$00B2,$004F,$00B5,$00B6,$00B7,$0098                   ;8CDFAB;
    dw $00B0,$009C,$004F,$009D,$009E,$009D,$009C,$009C                   ;8CDFBB;
    dw $0098,$009C,$004F,$004F,$004F,$004F,$004F,$004F                   ;8CDFCB;
...
CinematicBGObjectInstLists_Ending_ItemPercentage:
    ...
    dw Instruction_DrawItemPercentageFrenchText                          ;8CE0A3;
    dw $0080                                                             ;8CE0A5;
    db $00,$00                                                           ;8CE0A7;
    dw IndirectInstructions_Ending_Nothing                               ;8CE0A9;
    dw Instruction_ClearItemPercentageFrenchText                         ;8CE0AB;
