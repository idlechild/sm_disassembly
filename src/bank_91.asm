...
InstList_DemoInput_PseudoScrewAttack:                                    ;918C3E;
    ...
    dw $0010,$02C0,$0000 ;       < AX
    dw $0010,$0240,$0000 ;       <  X
    dw $001A,$0040,$0000 ;          X
    dw $0001,$0140,$0100 ;        > X
    dw $000C,$0140,$0000 ;        > X
    dw $0001,$01C0,$0080 ;        >AX
    dw $0005,$01C0,$0000 ;        >AX
    dw $0002,$00C0,$0000 ;         AX
    dw $0001,$02C0,$0200 ;       < AX
    dw $0018,$02C0,$0000 ;       < AX
    dw $0006,$0240,$0000 ;       <  X
    dw $0005,$0040,$0000 ;          X
    dw $0001,$0140,$0100 ;        > X
    dw $0009,$0140,$0000 ;        > X
    ...
    dw $002E,$0140,$0000 ;        > X
    dw $0001,$01C0,$0080 ;        >AX
    dw $0020,$01C0,$0000 ;        >AX
    dw $0001,$09C0,$0800 ;     ^  >AX
    dw $0002,$01C0,$0000 ;        >AX
    dw $0006,$00C0,$0000 ;         AX
    dw $000A,$0040,$0000 ;          X
    dw $0001,$0240,$0200 ;       <  X
    dw $0028,$0240,$0000 ;       <  X
    dw $0001,$02C0,$0080 ;       < AX
    dw $0006,$02C0,$0000 ;       < AX
    ...
    dw $0003,$00C0,$0000 ;         AX
    dw $0001,$00E0,$0020 ;         AXL
    dw $000E,$00E0,$0000 ;         AXL
    dw $0022,$0020,$0000 ;           L
    dw $0001,$0120,$0100 ;        >  L
    dw $0002,$0120,$0000 ;        >  L
    dw $0004,$0100,$0000 ;        >
    ...
    dw $001A,$8180,$0000 ; B      >A
    dw $0004,$8080,$0000 ; B       A
    dw $0005,$8000,$0000 ; B
    dw $0001,$0200,$0200 ;       <
    dw $000C,$0200,$0000 ;       <
    dw $0051,$0000,$0000 ;
...
InstList_DemoInput_BrinstarDiagonalRoom:                                 ;919560;
    ...
    dw $0017,$0050,$0000 ;          X R
    dw $0004,$0040,$0000 ;          X
    dw $0001,$0440,$0400 ;      v   X
    dw $002C,$0440,$0000 ;      v   X
    dw $00AF,$0000,$0000 ;
    dw Instruction_DemoInputObject_Delete
...
InstList_DemoInput_IBJ:                                                  ;919AF0;
    ...
    dw $0009,$0080,$0000 ;         A
    dw $0001,$0480,$0400 ;      v  A
    dw $0006,$0480,$0000 ;      v  A
    dw $0002,$0080,$0000 ;         A
    dw $0001,$0480,$0400 ;      v  A
    dw $0006,$0480,$0000 ;      v  A
    dw $0001,$04C0,$0040 ;      v  AX
    dw $0002,$04C0,$0000 ;      v  AX
...
InstList_DemoInput_CrystalFlash:                                         ;919DAE;
    ...
    dw $0007,$0430,$0000 ;      v    LR
    dw $0001,$0470,$0040 ;      v   XLR
    dw $000D,$0470,$0000 ;      v   XLR
    dw $0018,$0430,$0000 ;      v    LR
    dw $0001,$0470,$0040 ;      v   XLR
    dw $0098,$0470,$0000 ;      v   XLR
    dw $0002,$0070,$0000 ;          XLR
...
; 45h: Unused
; 46h: Unused
    db $02,$02,$02,$02,$02,$02,$02,$02,$02,$02,$FF                       ;91B20A;
...
; 37h: Facing right - morphing transition
    db $02,$02, $F9 : dw $0002 : db $1D,$31,$79,$7D

AnimationDelays_38:                                                      ;91B4D1;
; 38h: Facing left  - morphing transition
    db $02,$02, $F9 : dw $0002 : db $41,$32,$7A,$7E
...
; 3Dh: Facing right - unmorphing transition
    db $02,$02, $FD,$27                                                  ;91B4E6;

AnimationDelays_3E:
; 3Eh: Facing left  - unmorphing transition
    db $02,$02, $FD,$28                                                  ;91B4EA;
...
UNUSED_AnimationDelays_DB_91B4FA:                                        ;91B4FA;
    db $02,$02,$02, $F9 : dw $0002 : db $1D,$31,$79,$7D

UNUSED_AnimationDelays_DC_91B504:                                        ;91B504;
    db $02,$02,$02, $F9 : dw $0002 : db $DF,$DF,$DF,$DF

UNUSED_AnimationDelays_DD_91B50E:
    db $02,$02,$02, $FD,$01                                              ;91B50E;

UNUSED_AnimationDelays_DE_91B513:
    db $02,$02,$02, $FD,$BA                                              ;91B513;
...
; F0h: Facing right - grabbed by Draygon - moving
    db $05,$05,$05,$05,$05,$05,$FF                                       ;91B53C;
...
AnimationDelayTable_Running_NoSpeedBooster:
    db $01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$FF                       ;91B5D3;
